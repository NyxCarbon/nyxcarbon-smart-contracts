...
import {_NYXCC_PROJECT_NAME_DATA_KEY, _NYXCC_REGISTRY_LINK_DATA_KEY, _NYXCC_UNITS_DATA_KEY, _NYXCC_GEOGRAPHIC_IDENTIFIER_DATA_KEY} from "./constants.sol";
...
contract CarbonCreditNFTCollection is LSP8Mintable {
    ...
    function mintCarbonCreditNFT(
        ...
        dataKeys[3] = _NYXCC_GEOGRAPHIC_IDENTIFIER_DATA_KEY;
