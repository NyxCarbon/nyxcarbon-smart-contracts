...
interface ILYXLoanContract {
     ...
     * @param projectLink The link to information about the project.
     ...
     * @param verificationLink The link where the verified project data can be found.
