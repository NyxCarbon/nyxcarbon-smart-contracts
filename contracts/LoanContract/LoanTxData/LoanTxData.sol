...
contract LoanTxData is LSP8Mintable {
    constructor(
        string memory name_,
    ...
    function mintNFT(
        ...
        dataKeys[12] = _NYX_VERIFIED_PROJECT_NAMES;
        dataKeys[13] = _NYX_VERIFIED_PROJECT_LINKS;
        dataKeys[14] = _NYX_VERIFIED_PROJECT_UNITS;
