...
import { LUKSO_LOAN_MATH, LUKSO_LOAN, LUKSO_LOAN_NFT } from './constants';
...
async function main() {
  ...
  const loanNFT = (await ethers.getContractFactory("NonCollateralizedLoanNFT")).attach(LUKSO_LOAN_NFT);
